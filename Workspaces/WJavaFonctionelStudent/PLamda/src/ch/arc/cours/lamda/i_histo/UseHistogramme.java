...
public class UseHistogramme
	...
	private static void histoStreamParalel2()
		...
		Map<Integer, Long> mapHisto2 = IntStream.range(0, n).parallel().boxed().collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
		...
		IntStream.range(0, LIMITE).forEach(i -> histo[i] = mapHisto1.get(i));
